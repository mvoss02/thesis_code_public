...
df_results = pd.read_csv("results_environmental.csv")
...
# # write to csv
# df_results.to_csv(r"results_environmental.csv")
...
# # Append to dataframe
# df_results = df_results.append({'Model': 'GBM_ada_without_class_weights', 'Accuracy': accuracy_score(y_test_gbm, y_pred_gbm),
#                                 'Parameters': pipe.named_steps,
#                                 'Precision': precision_score(y_test_gbm, y_pred_gbm),
#                                 'Recall': recall_score(y_test_gbm, y_pred_gbm),
#                                 'F1 Score': f1_score(y_test_gbm, y_pred_gbm),
